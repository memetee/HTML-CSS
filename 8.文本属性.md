...
所以只有一行的时候，justiry是没有效果的，因为，只有一行的时候它虽然是第一行，但是它也是最后一行。

那么如果想设置最后一行怎么办呢？

```css
text-align-last: justiry;
```
...
<img src="8.文本属性.assets/image-20231121223303346.png" alt="image-20231121223303346" style="zoom: 67%;" />



`word-spacing: 8px;`

![image-20231121223348039](8.文本属性.assets/image-20231121223348039.png)
...
- **百分比**
  ...
  - 文**档中宽度**就**不是相当于父元素**，而是**相当于包含块**
    ...
    ![image-20231121224955555](8.文本属性.assets/image-20231121224955555.png)
...
- em
  ...
  - 相对于**父元素的字体大小**，如果父元素没有字体大小，相对于**浏览器的字体大小（默认16px）**，也可以说是**继承了父元素的字体大小**。
    ...
    ![image-20231121225428171](8.文本属性.assets/image-20231121225428171.png)
